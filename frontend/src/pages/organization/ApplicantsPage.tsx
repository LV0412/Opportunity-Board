              ...
              <div key={application.id} className="grid gap-4 border-b border-border px-4 py-4 text-sm last:border-b-0 md:grid-cols-[1.2fr_1fr_1fr_160px]">
                ...
                <div>
                  ...
                  {application.resumeFileUrl ? (
                    <a className="inline-flex items-center gap-2 font-semibold text-primary" href={application.resumeFileUrl} target="_blank" rel="noreferrer">
                      <FileText className="h-4 w-4" aria-hidden="true" />
                      {application.resumeFileName ?? "CV"}
                    </a>
                  ) : (
